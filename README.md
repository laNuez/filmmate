...
## Design choices
- **Fron-end**: I considered using a JavaScript framework such as React or Svelte, but ultimately decided to use none, as the project would not require much client-side interactivity, due to all the logic happening on the backend.
...
## Documentation
[Supabase](https://supabase.com/docs/reference/python/start)  
